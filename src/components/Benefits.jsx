...
export default function Benefits() {
  return (
    <div className="flex flex-col items-center justify-center w-full mb-8 px-6 md:px-20">
      <div className="flex flex-col w-full">
        <p className="text-[#077252] font-[700] text-sm tracking-wider self-start">
          HOW WE WORK
        </p>
        <h1 className="text-[#333] font-[700] text-3xl md:text-5xl mb-16 tracking-tight text-center md:text-left">
          Our benefits and skills that make you happy
        </h1>
      </div>

      <div className="flex flex-col w-full space-y-16 md:space-y-0">
        {/* Benefit 01 */}
        <div className="flex flex-col md:flex-row justify-center items-center w-full mb-16">
          <div className="text-left flex-1">
            <p className="text-[#ddd] text-6xl md:text-9xl font-medium">01</p>
        ...
        <div className="flex flex-col md:flex-row-reverse justify-center items-center w-full mb-16">
          <div className="text-left flex-1">
            <p className="text-[#ddd] text-6xl md:text-9xl font-medium">02</p>
            <p className="font-[700] text-[#333] text-2xl tracking-wide mt-4">
          ...
          <div className="bg-[#e6f2ef] h-[50%] w-fit flex-1 flex mr-8 p-4 rounded-lg justify-center items-center">
            <div className="bg-[#b5d9ce] p-4 flex justify-center items-center h-full rounded-lg">
              <img
        ...
        <div className="flex flex-col md:flex-row justify-center items-center w-full mb-16">
          <div className="text-left flex-1">
            <p className="text-[#ddd] text-6xl md:text-9xl font-medium">03</p>
            <p className="font-[700] text-[#333] text-2xl tracking-wide mt-4">
